    ...
    <>
      ...
      >
        <span style={{ margin: '0px 0px 14px' }}>
          <strong>Buy 2 Echo Dot (3rd Gen) for £29.98</strong> when you add 2 units to cart and apply the{' '}
          <strong> promo code 2ECHODOT3</strong> at check-out. <u>Terms apply</u>
        </span>
      </div>
    </>
  )
